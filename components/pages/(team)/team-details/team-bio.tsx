            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        >
                            <Image
                                src="/assets/images/team/member-fbio-img.png"
                                alt="member"
                                height={600}
                                width={636}
                                className="h-100"
                    ...
                    <div className="col-lg-6 tab-col-gap">
                        ...
                        >
                            ...
                            <p className="mb-3">
                                My name is Edoardo Romussi. In my 6 years of
                                work experience in SEO, I have gain designed
                                digital experiences.
                            </p>
                            <p>
                                My motivation has always been to understand and
                                We from people, which is why in my professional
                                development, I havefocused for my attention on
                                working experience design.
                            </p>
                    ...
                    <div className="col-lg-6">
                        <div className="member-experience">
                            ...
                            <p>
                                ...
                                architecto dolorem ipsum When an unknown printer

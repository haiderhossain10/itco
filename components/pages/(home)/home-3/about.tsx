                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="sec-content h-100 d-flex justify-content-center flex-column">
                            ...
                            <p className="sec-text">
                                Team is a diverse network of consultants and
                                industry professionals with a global mindset and
                                a collaborative culture. We work to mindset
                                understand your issues and are to ask better
                                questions.
                            </p>
                    ...
                    <div className="col-lg-6 tab-col-gap">
                        <div className="sec-images">
                            ...
                            >
                                <Image
                                    src="/assets/images/about/about04.png"
                                    alt="about-img"
                                    height={559}
                                    width={560}
                                    className="h-100"
                            ...
                            >
                                <Image
                                    src="/assets/images/about/abouts02.png"
                                    alt="about-img"
                                    height={559}
                                    width={560}
                                    className="h-100"

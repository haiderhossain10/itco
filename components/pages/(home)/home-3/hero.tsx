                ...
                >
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url("assets/images/hero/hero-slider1.png")',
                            }}
                        >
                            {/* hero-slider-item1 */}
                    ...
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url("assets/images/hero/hero-slider2.png")',
                            }}
                        >
                            {/* hero-slider-item2 */}
                            <div className="slider-img-overlay">
                    ...
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url("assets/images/hero/hero-slider3.png")',
                            }}
                        >
                            {/* hero-slider-item3 */}
                            <div className="slider-img-overlay">
